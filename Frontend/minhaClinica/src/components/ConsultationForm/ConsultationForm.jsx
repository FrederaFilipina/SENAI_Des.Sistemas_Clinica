                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-4'>
                                ...
                                <div>
                                    ...
                                    <textarea name='description' id='description' value={formData.description} rows={3} 
                                    onChange={handleInputChange} required
                                ...
                                <div>
                                    ...
                                    <input type='text' name='medication' id='medication' value={formData.medication} 
                                    onChange={handleInputChange} required
                                    className='w-full border p-2 rounded-lg focus:ring-2 focus:ring-cyan-600 outline-none' />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type='text' name='dosagePrecautions' id='dosagePrecautions'
                                    value={formData.dosagePrecautions} onChange={handleInputChange} required
                                    className='w-full border p-2 rounded-lg focus:ring-2 focus:ring-cyan-600 outline-none'/>
                                </div>
